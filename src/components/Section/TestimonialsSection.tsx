  ...
  return (
    <section className="py-10 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ArchitecturalContainer className="text-center mb-8 sm:mb-12">
          <div className="flex items-center justify-center mb-3 sm:mb-4">
            <div className="w-10 sm:w-16 h-px bg-gradient-to-r from-[#2ECB98] to-[#28B888]"></div>
            <div className="mx-3 sm:mx-4 text-[#2ECB98] text-xs sm:text-sm font-medium tracking-[0.15em] sm:tracking-[0.2em] uppercase">
              Testimonios
            </div>
            <div className="w-10 sm:w-16 h-px bg-gradient-to-r from-[#28B888] to-[#2ECB98]"></div>
          </div>
          ...
          {testimonios.map((testimonio, index) => (
            <GlassmorphismContainer key={testimonio._key} className="group h-full">
              ...
              <div className="mb-4 sm:mb-6">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#2ECB98]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
                </svg>
              </div>

              {/* Testimonial text */}
              <blockquote className="text-[#BBBBBB] text-base sm:text-lg leading-relaxed mb-6 sm:mb-8 italic">
                &quot;{testimonio.texto}&quot;
              </blockquote>
              ...
              <div className="flex items-center">
                {testimonio.avatar && (
                  <div className="relative h-10 w-10 sm:h-12 sm:w-12 flex-shrink-0 overflow-hidden rounded-xl border border-[#333333]">
                    <Image
                ...
                <div className="ml-3 sm:ml-4">
                  <p className="font-medium text-white uppercase tracking-wide text-sm sm:text-base">
                    {testimonio.autor}
                  </p>
                  <div className="text-[#2ECB98] text-xs sm:text-sm font-medium">
