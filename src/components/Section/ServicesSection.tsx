              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 p-8 h-full flex flex-col justify-end">
                    <div className="mb-6">
                      <div className="w-12 h-12 bg-[#2ECB98]/20 rounded-lg flex items-center justify-center mb-4">
                        <div className="w-6 h-6 bg-[#2ECB98] rounded"></div>
                      </div>
                    </div>

                    <h3 className="font-['Oswald'] text-2xl font-bold text-white uppercase tracking-wide mb-3 group-hover:text-[#2ECB98] transition-colors duration-300">
                      {servicio.nombre}
                    </h3>
                    ...
                    {servicio.textoCTA && servicio.urlCTA && (() => {
                      ...
                      if (isComingSoon) {
                        return (
                          <DevelopmentTooltip message="En Desarrollo">
                            <button className="inline-flex items-center justify-center px-6 py-3 bg-[#333333] text-gray-400 font-medium rounded-lg cursor-not-allowed border border-dashed border-gray-600">
                              {servicio.textoCTA}
                      ...
                      return (
                        <Link 
                          ...
                          className="inline-flex items-center justify-center px-6 py-3 bg-[#2ECB98] hover:bg-[#26B88A] text-black font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-[#2ECB98]/20"
                        >
                          {servicio.textoCTA}
                          <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
