...
export default function HeroSection({ section }: Props) {
  ...
  return (
    <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
      ...
      <div className="relative z-20 flex items-center h-[60vh] md:h-[70vh]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            <div className="col-span-12 lg:col-span-8 xl:col-span-7">
              ...
              {/* Static Title */}
              <h1 className="font-bold text-[#EAEAEA] leading-[0.95] tracking-tight mb-8 md:mb-12 [text-shadow:_0_4px_12px_rgb(0_0_0_/_90%)]">
                <span className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl uppercase">
              ...
              <div className="relative mb-8 md:mb-12">
                ...
                <p className="text-[#EAEAEA] text-base sm:text-lg md:text-xl lg:text-xl leading-relaxed max-w-2xl [text-shadow:_0_3px_8px_rgb(0_0_0_/_80%)]">
                  {subtitulo || "Subtítulo o párrafo descriptivo"}
                </p>
              </div>

              {/* Static CTA Buttons */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-8 space-y-4 sm:space-y-0 mt-6">
                {/* Primary Button */}
                {textoBotonPrimario && (
                  <a 
                    href={urlBotonPrimario || '#'}
                    className="group relative bg-[#8A2BE2] text-white font-['Oswald'] font-bold text-sm md:text-base px-6 md:px-8 py-3 md:py-4 uppercase tracking-wider transition-all duration-300 hover:bg-[#9A3BF2] hover:shadow-lg hover:shadow-[#8A2BE2]/25 focus:outline-none focus:ring-2 focus:ring-[#8A2BE2] focus:ring-offset-2 focus:ring-offset-[#1A1A1A] w-fit"
                  >
                ...
                {textoBotonSecundario && (
                  <a 
                    ...
                    className="group relative bg-transparent border-2 border-[#8A2BE2] text-[#8A2BE2] font-['Oswald'] font-bold text-sm md:text-base px-6 md:px-8 py-2 md:py-3 uppercase tracking-wider transition-all duration-300 hover:bg-[#8A2BE2] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#8A2BE2] focus:ring-offset-2 focus:ring-offset-[#1A1A1A] w-fit"
                  >
