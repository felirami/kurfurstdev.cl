...
export default function PortfolioCard({ proyecto, index = 0 }: Props) {
  ...
  return (
    <ScrollAnimatedSection 
      ...
      duration={0.6}
    >
      <GlassContainer className="group h-[500px] overflow-hidden hover:border-[#8A2BE2]/50 transition-all duration-500" padding="p-0">
        <motion.div
          className="h-full"
          whileHover={{ y: -8 }}
        ...
        >
          ...
          <div className="relative h-[40%] bg-[#1A1A1A]/80 backdrop-blur-sm p-6 flex flex-col justify-between">
            {/* Category Tag */}
            <div className="mb-3">
